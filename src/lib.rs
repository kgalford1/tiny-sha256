...
mod test { 
    ...
    fn green_eggs() {
        let exp: [u8;32] = [
            0xa1, 0x13, 0xa9, 0x85, 0x4a, 0xb7, 0x1a, 0x49,
            0x14, 0xe2, 0x19, 0xe1, 0x81, 0xca, 0x8b, 0xfd,
            0x48, 0xd7, 0xd6, 0x5b, 0xdb, 0x1c, 0x3c, 0xb1,
            0xba, 0xd6, 0x23, 0x5c, 0x5f, 0x1a, 0xcf, 0x23
        ];
        let mut hasher = Sha256::new();
    ...
    fn apples() {
        let exp: [u8;32] = [
            0x8a, 0x2f, 0x37, 0x66, 0xed, 0xc0, 0x22, 0x81, 
            0xf8, 0x48, 0xcc, 0x80, 0xb9, 0xdf, 0xe9, 0xef, 
            0xe1, 0x57, 0xd8, 0xa0, 0xa7, 0xb8, 0xbc, 0x3d, 
            0xab, 0x6b, 0x8b, 0xdb, 0x65, 0x1e, 0x2b, 0x9c
        ];
        let mut hasher = Sha256::new();
        for _ in 0..32 {
